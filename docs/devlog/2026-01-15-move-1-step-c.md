...
4. **In App (Terminal 4):**
   ...
   - Should show: "1 pending" → "0 pending" (after ~2s)
...
- [ ] Create page in Notion, received in Dev Server ✅
- [ ] SyncIndicator shows pending count ✅
- [ ] Queue processes automatically (5s) ✅
- [ ] SQLite shows "processed" status ✅
- [ ] Update page, webhook received ✅
- [ ] Delete page, webhook received ✅
- [ ] 3 operations total process correctly ✅
...
3. Notion integration shared: Database → Share → Check integration listed
4. Webhook URL correct: Notion API → Webhooks → Check notification_url
...
1. App console: F12 → Console tab, look for fetch errors
