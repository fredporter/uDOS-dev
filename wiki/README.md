...
**Python-venv OS layer targeting Alpine Linux**  
...
| Document                             | Audience  | Purpose                        |
| ------------------------------------ | --------- | ------------------------------ |
| [Alpine Stack](./tinycore/README.md) | Deployers | Installation & plugin packages |
...
├── tinycore/              # Distribution (deprecated; see Alpine docs)
